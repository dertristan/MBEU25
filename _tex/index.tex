...
\urlstyle{same}
\hypersetup{
  pdftitle={Penalized for Faith: What Drives the Muslim Penalty?},
...
\title{Penalized for Faith: What Drives the Muslim Penalty?}
\usepackage{etoolbox}
\makeatletter
...
otherwise comparable profiles. We move beyond this average and ask what
...
essentially every subgroup we examine. Other attributes of the displayed
profile moderate it only weakly. In contrast, respondent characteristics
...
The conventional estimand in conjoint experiments is the Average
Marginal Component Effect (AMCE, for definition see
...
both games. Nationality moderates the penalty as well. Profiles
displayed as EU nationals draw the largest penalty and co-nationals an
intermediate one, while non-EU nationals draw the smallest but on
noticeably wider intervals. The penalty thus appears deepest not for the
most distant, non-EU profile but for the fellow EU national, a contrast
the imprecise non-EU estimates leave only suggestive. Social class moves
the penalty only at its upper end, where lower- and middle-class
...
co-nationals attenuates it most.
...
\bottomrule\noalign{}
\endlastfoot
cj\_nationality\_shown & & \\
eu & 31,546 (25\%) & 10,572 (25\%) \\
non\_eu & 8,660 (6.8\%) & 2,988 (7.0\%) \\
own\_country & 86,457 (68\%) & 28,983 (68\%) \\
