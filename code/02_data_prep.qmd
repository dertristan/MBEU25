...
slots <- c("cj_dict1", "cj_dict2", "cj_dict3", "cj_trust1", "cj_trust2", "cj_trust3")
...
eu25_long <- eu25_long |>
  mutate(
    ...
    der_cj_partisanship = case_when(
      ...
      cj_treatment == "4_somenat" & cj_nationality_shown == "own_country" ~ "not_shown",
...
count(eu25_long, cj_treatment, cj_nationality_shown) |>
  kable(caption = "Shown nationality by treatment condition (now treatment-dependent).")
```
