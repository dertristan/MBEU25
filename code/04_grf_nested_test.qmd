...
- **The outcome** (`y`): the linear predictor sums the prognostic surface, the treatment effect applied only to treated units (`tau_x * z`), the country and respondent offsets, and noise. The outcome is continuous, matching the continuous path tested in the BCF notebook.
