...
fit_bcf <- function(d) {
  ...
  bcf_continuous_linear(
    ...
    x_moderate = d$sub_X,
    zhat = rep(0.5, length(d$y)), # known conjoint propensity
...
saveRDS(fit_dict, here::here("data", "03_final", "bcf_dictator.rds"), compress = "xz")
...
saveRDS(fit_trust, here::here("data", "03_final", "bcf_trust.rds"), compress = "xz")
